...
GRAPH_INTERVAL = config.GRAPH_INTERVAL  #os.environ.get("GRAPH_INTERVAL", 5000)
app_color = config.app_color  #{"graph_bg": "#082255", "graph_line": "#007ACE"}
...
column2 = dbc.Col(
    [
        ...
        html.Div(
            [
                html.Div([html.H6("MOMENTUM GAUGE", className="graph__title")]),
                dcc.Graph(
                    id="momentum-gauge",
                    figure=go.Figure(
                        layout=go.Layout(
