...
def train(params: DictConfig) -> None:
    ...
    model.load(model_name="lstm_20210106_20210106_1m", origin_pwd=True)
...
# D:\user\projects\btc_dash\btc_predictor\btc_predictor\saved_model\lstm_20210106_20210106_1m\model_attr.json
